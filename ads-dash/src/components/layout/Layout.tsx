...
const ITEMS = {
  ...
  demandas:     { n: '17', to: '/demandas',     label: 'Demandas',      hint: 'KANBAN',   icon: 'M4 4h6v6H4z M14 4h6v6h-6z M4 14h6v6H4z M14 14h6v6h-6z' },
...
const GROUPS = [
  ...
  { key: 'sistema',      label: 'SISTEMA',      keys: ['integrations', 'alerts', 'demandas', 'settings'] },
]
