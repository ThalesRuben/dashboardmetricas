-- 0019_whatsapp_agendamentos_period.sql
-- Passa agendamentos a respeitar a janela de período no get_whatsapp_summary.
-- Decisão de produto revisada em 2026-07-02: o KPI ficou "total existente
-- hoje" no 0018, mas na prática o user quer "agendamentos feitos no período"
-- pra bater com a conversas/leads/vendas.
--
-- Como whatsapp_threads não tem histórico de mudança de status, o proxy
-- adotado é o mesmo dos outros KPIs: criado_em dentro da janela.
...
begin
  ...
  -- Agendamentos = threads CRIADAS no período que hoje estão como 'agendado'
  ...
  -- Deltas: janela anterior de mesmo tamanho
